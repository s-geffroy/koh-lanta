...
chapeau: >-
  Vingt-trois entrées dans le même jeu de données. Onze comptent ce qui
  s’est passé ; douze le mettent à l’épreuve d’un modèle.
---
...
et des moyennes. Les douze dernières **testent** — elles comparent ce qu’on
