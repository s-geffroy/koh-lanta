...
chapeau: >-
  Vingt et une entrées dans le même jeu de données. Onze comptent ce qui
  s’est passé ; dix le mettent à l’épreuve d’un modèle.
---
...
et des moyennes. Les dix dernières **testent** — elles comparent ce qu’on
