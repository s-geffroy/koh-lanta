...
chapeau: >-
  Dix-neuf entrées dans le même jeu de données. Onze comptent ce qui s’est
  passé ; huit le mettent à l’épreuve d’un modèle.
---
...
et des moyennes. Les huit dernières **testent** — elles comparent ce qu’on
