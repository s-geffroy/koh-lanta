...
chapeau: >-
  Vingt-deux entrées dans le même jeu de données. Onze comptent ce qui
  s’est passé ; onze le mettent à l’épreuve d’un modèle.
---
...
et des moyennes. Les onze dernières **testent** — elles comparent ce qu’on
